...
const UI = [
  ...
  'gutterexclude', 'sheetbarge', 'jpmaps', 'jpallroofs', 'newjobkeep', 'report50', 'sheetclaim', 'cutlistwire', 'report51', 'report52', 'fergstale', 'untitledjob', 'joblock', 'sitecopy', 'aboutyou', 'viewkeep', 'dailyreport', 'apptime',
];
