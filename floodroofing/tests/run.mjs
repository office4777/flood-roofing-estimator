...
const UI = [
  ...
  'gutterexclude', 'sheetbarge', 'jpmaps', 'jpallroofs', 'newjobkeep', 'fergstale', 'untitledjob', 'joblock', 'sitecopy', 'aboutyou', 'viewkeep', 'dailyreport', 'apptime',
];
