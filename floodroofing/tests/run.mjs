...
const API = [
  'orgapi', 'teamapi', 'domainapi', 'dupjob', 'jobsave', 'plans', 'cors', 'errmon', 'usage', 'trial', 'invoiceapi', 'stripeapi', 'billingoff', 'security', 'register', 'sharetoken', 'acceptflow', 'crosstenant', 'bodylimit', 'markupleak', 'revisionapi', 'mailidentity', 'platformmail', 'waitlist', 'metrics', 'flashguard', 'quoteremind', 'quotestats', 'resendmail', 'maildomain', 'tenantaddr', 'ferguskey', 'scheduleapi', 'inboxapi', 'grandfather', 'jmsdiag', 'revoke',
];
// The real app.html, driven by Playwright.
const UI = [
  'tenantbrand', 'ownbrand', 'heroslot', 'poleshed', 'orderdelivery', 'quotetpl', 'pbflags', 'billingready', 'pricebook', 'samplejob', 'crashui', 'landing', 'signup', 'quotedomain',
  'gutterprice', 'officebar', 'roofrename', 'acceptcarry', 'orgui', 'teamui', 'dupjobui',
  'trialui', 'navplan', 'jobhistory', 'legal', 'photospanel', 'aerialmap', 'invoiceui', 'jobfiles', 'nojms', 'billingui', 'disclaimers', 'matbuffer', 'pbcsv', 'selectables', 'selcopy', 'selextras', 'profilecover', 'pricegold', 'pipeflash', 'sheetruns', 'siteflash', 'siteflashpad', 'boxpentrace', 'flashwaste', 'sitebars', 'jmsrequest', 'fbcontext', 'roofimg', 'freedraw', 'roofnotes', 'rapidcam', 'roofsafe', 'fbgeom', 'pbextras', 'setupguide', 'flashdelete', 'clearlite', 'monocount', 'jpedit', 'pricingmap', 'foldedpricing', 'report46', 'pbextraqty', 'boxpenflash', 'roofnamemap', 'chainwalk', 'canvassetup', 'clearbg', 'roofmenu', 'sheetrun1024', 'bgmatch', 'tutorial', 'seo', 'sitebrand', 'quotelink', 'quotebar', 'roofhistory', 'lkgguard', 'rotatefine', 'snapreach', 'roofpitch', 'pricingarea', 'fergussplit', 'gradetruth', 'autopush', 'hbdelete', 'livequote', 'delivmail', 'restoredrill', 'roofmapcrop', 'platformscaff', 'draftbg', 'clearfit', 'emailtpl', 'extrasguard', 'truemeas', 'notifybell', 'flashpitch', 'custbarside', 'suppliercolours', 'qnstats', 'maildomainui', 'grandfatherui', 'hroofsnap', 'rectroof', 'roofreal', 'hip45', 'gableshapes', 'sheetstep', 'cornerpad', 'savemoved', 'appupdate', 'autoscale', 'jmsdiagui', 'fbkind', 'scalecaution', 'scheduleui', 'schedimport', 'whoami', 'inboxui',
  ...
  'gutterexclude', 'sheetbarge', 'jpmaps', 'fergstale', 'untitledjob', 'joblock', 'sitecopy', 'aboutyou', 'viewkeep', 'dailyreport', 'apptime',
];
