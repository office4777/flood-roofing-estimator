...
const UI = [
  ...
  'gutterexclude', 'sheetbarge', 'jpmaps', 'jpallroofs', 'newjobkeep', 'report50', 'sheetclaim', 'cutlistwire', 'fergstale', 'untitledjob', 'joblock', 'sitecopy', 'aboutyou', 'viewkeep', 'dailyreport', 'apptime',
];
