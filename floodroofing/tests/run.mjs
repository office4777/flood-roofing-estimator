...
const API = [
  'orgapi', 'teamapi', 'domainapi', 'dupjob', 'plans', 'cors', 'errmon', 'usage', 'trial', 'invoiceapi', 'stripeapi',
];
...
const UI = [
  ...
  'trialui', 'legal', 'photospanel', 'aerialmap', 'invoiceui', 'jobfiles', 'nojms', 'billingui',
];
